 ...
 *
 * Vendored from @alicekk/sol-opencode-core (sol-opencode/packages/core/src/compact/economics.ts)
 * into sol-zcode as ESM JavaScript with type erasure only; algorithm and
 * constants are unchanged (memo/keepRecent/ratio/first-scale/subsequent-margin/
 * window-reserve are all consumed by the adapter). Adapter-visible deviation: none.
 */
